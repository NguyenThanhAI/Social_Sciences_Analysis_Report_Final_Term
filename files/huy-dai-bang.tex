...
Hình \ref{fig:null_percentage_columns} thể hiện số lượng giá trị null trong từng biến. Từ hình \ref{fig:null_percentage_columns}, ta rút ra được nhận xét rằng hầu hết các biến của tập dữ liệu đều có các giá trị rỗng.
...
\begin{table}[h!]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{|l|c|c|c|c|c|c|c|c|c|}
            ...
            \hline
            Giá trị rỗng & 1398 & 1218 & 1218 & 9 & 111 & 1482 & 1495 & 1495 & 3 \\
            \hline
            Giá trị khác rỗng & 1469 & 1649 & 1649 & 2858 & 2756 & 1385 & 1372 & 1372 & 2864 \\
            \hline
            Tỷ lệ giá trị rỗng (\%) & 48.7\% & 42.4\% & 42.4\% & 0.3\% & 3.8\% & 51.7\% & 52.1\% & 52.1\% & 0.1\% \\
            \hline
        \end{tabular}
    }
