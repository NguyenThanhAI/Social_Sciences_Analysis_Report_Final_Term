...
\subfile{files/phan_chia_cong_viec.tex}
    % \begin{enumerate}
    ...
    \section{Kiểm định mối quan hệ giữa việc sử dụng mạng xã hội (Snapchat, Instagram) và tình trạng việc làm của một cá nhân}
    
    \subfile{files/using_social_media.tex}
