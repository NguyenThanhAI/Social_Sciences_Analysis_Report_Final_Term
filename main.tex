...
\begin{itemize}
    \item $https://machinelearningcoban.com/2017/02/17/softmax/$
    \item $https://en.wikipedia.org/wiki/Logistic_regression\#Bayesian$
    \item $https://agustinus.kristia.de/techblog/2017/01/01/mle-vs-map/$
    \item $https://en.wikipedia.org/wiki/Random_forest$
\end{itemize}
