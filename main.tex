...
\section{CÁC MÔ HÌNH}
\subsection{Mô hình hồi quy Softmax}
\subfile{files/multinomial_logistic_regression.tex}

\subsection{Mô hình Hồi quy Softmax theo phương pháp thống kê Bayes}
\subfile{files/bayesian_multinomial_logistic_regression.tex}

\subsection{Mô hình phân lớp Random forest}
...
\begin{itemize}
    \item \url{https://machinelearningcoban.com/2017/02/17/softmax/}
    \item \url{https://en.wikipedia.org/wiki/Logistic_regression\#Bayesian}
    \item \url{https://agustinus.kristia.de/techblog/2017/01/01/mle-vs-map/}
    \item \url{https://machinelearningcoban.com/tabml_book/ch_model/decision_tree.html}
    \item \url{https://en.wikipedia.org/wiki/Random_forest}
    \item \url{https://en.wikipedia.org/wiki/XGBoost}
\end{itemize}
